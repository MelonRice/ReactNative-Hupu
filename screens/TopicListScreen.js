...
import { Container, Content, List, ListItem, Text, Button, Icon, Spinner, Card, CardItem, Header, Footer, Body, Left, Right } from 'native-base';
...
class TopicListScreen extends React.Component {
    ...
    renderHeader = () => {
        if(this.props.store.selectedSubForum) {
            return (<Card>
                <CardItem cardBody>
                    <ImageBackground source={{uri: this.props.store.selectedSubForum.backImg}} style={{height: 200, width: null, flex: 1, backgroundColor:'transparent', justifyContent: 'center',  alignItems: 'center',}} >
        ...
        return (
            <Container>
                    ...
                    <List
                        ...
                        renderRow={(e) =>
                            <ListItem onPress={this._handleEntryPress.bind(this, e)} noBorder style={{ borderWidth: 0, margin: 0, padding: 0 }}>
