...
import { Container, Content, Header, List, ListItem, Card, CardItem, Left, Thumbnail, Body, Text , Button, Icon, Spinner } from 'native-base';
                                        ...
                                        <List noBorder>
                                            {
                                                e.data && e.data.map((f, j) => {
                                                    return (
                                                        <ListItem noBorder avatar key={j} onPress={this._handleEntryPress.bind(this, f)} style={{ borderWidth: 0, marginBottom: 5 }}>
                                                            <Left >
